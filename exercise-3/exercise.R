...
words <- c("Kelly", "Bird", "Happy", "Lovely", "Wishful", "Hello")
...
words_of_the_day <- paste0("'", words, "'", " is the world of the day")
...
word_bin <- function(words, letter_one, letter_two) {
  word_vector <- words[substring(words, 1, 1) >= letter_one & substring(words, 1, 1) <= letter_two]
}

# Use your `word_bin` function to determine which of your words start with "e" 
# through "q"

test <- word_bin(words, "e", "q")
